...
import { addNewSmurf, showError } from '../actions/index';
...
const AddForm = (props) => {
    ...
    const handleSubmit = e => {
        ...
        if (state.name === "" || state.position === "" || state.nickname === "") {
            ...
            props.addNewSmurf(state.name, state.position, state.nickname, state.description, state.id)
        }
    }
...
export default connect(mapState, { addNewSmurf, showError })(AddForm);
